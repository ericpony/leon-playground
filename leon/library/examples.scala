Note: I haven't found reduce examples yet.
...
// https://github.com/Com-Mean/learningSpark/blob/master/chapter4/actions.py
...
// ===================================
// The following examples are found by Yu-Fang
// ===================================

https://github.com/PasaLab/marlin
 DESC: A Distributed Matrix Operations Library Built on Top of Spark
 PROBLEMS: aggregate is used in a private function, no so easy to trace back. It is used for the computation of SVD.

https://github.com/amplab/keystone
 DESC: Simplifying robust end-to-end machine learning on Apache Spark. http://keystone-ml.org/
 PROBLEMS: The following class of computing confusion matrix is non-det.
